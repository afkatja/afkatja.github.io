...
export function AboutSection() {
  ...
  return (
    <>
      ...
      <FAQSection
        title="Common Questions About My Work"
        subtitle="Curious about my AI projects, development approach, or availability? Here are answers to frequently asked questions."
      />
      <AuthorBlock />
    </>
  )
